...
plt.subplot(5,1,1)
plt.title(title)
plt.plot(timesteps, amplitudes*100, label="A")
#plt.xlabel("seconds")
...
plt.plot(force_timesteps, thrust_theta_angle, label="$\\beta_c$")
plt.legend()
plt.xlim(0,experiment_length)
plt.ylim(0,25)
plt.yticks(np.arange(0, 30, 5))
...
plt.plot(force_timesteps[amplitude_start_index:], thrust_phi_angle[amplitude_start_index:], label="$\psi_c$")
